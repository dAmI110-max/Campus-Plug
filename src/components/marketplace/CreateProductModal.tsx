    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
        <motion.div
          ...
          className="bg-white rounded-3xl max-w-2xl w-full p-5 sm:p-8 shadow-2xl border border-slate-100 relative my-6 max-h-[92vh] flex flex-col overflow-hidden"
        >
          {/* Header */}
          <div className="flex items-center justify-between pb-4 border-b border-slate-100 shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg sm:text-xl font-bold text-slate-900">Sell Something on Campus</h2>
                <p className="text-xs text-slate-500">Post items to UNIOSUN students with zero listing fees</p>
              </div>
            </div>
          ...
          <div className="overflow-y-auto pr-1 py-4 flex-1">
            {showPreview ? (
              /* LIVE PREVIEW CARD */
              <div className="max-w-md mx-auto p-4 bg-slate-50 rounded-3xl border border-slate-200 space-y-4">
                <div className="text-xs font-bold text-slate-400 uppercase tracking-wider">Listing Card Preview</div>
                <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                  <div className="aspect-square bg-slate-100 relative">
                    ...
                    />
                    <span className="absolute top-2.5 left-2.5 text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-200">
                      {condition}
                    </span>
                  </div>
                  <div className="p-4 space-y-2">
                    ...
                    <h3 className="font-bold text-slate-900 text-sm line-clamp-1">{title || 'Your Product Title'}</h3>
                    ...
                    <div className="pt-2 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                      ...
                      <span className="font-medium text-slate-700">{currentUser?.fullName}</span>
                    </div>
                  </div>
                </div>
                <button
                  ...
                  className="w-full py-2 bg-slate-200 text-slate-700 font-semibold text-xs rounded-xl"
                >
                  Continue Editing
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium focus:outline-hidden focus:border-emerald-500"
                    >
                      <option value="New">New (Brand New in Box)</option>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">Price (₦ Naira) *</label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold focus:outline-hidden focus:border-emerald-500"
                      />
                    </div>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2.5 mb-3">
                    ...
                    {imageUrls.length < 5 && (
                      <label className="w-20 h-20 rounded-xl border-2 border-dashed border-slate-300 hover:border-emerald-500 bg-slate-50 hover:bg-emerald-50/50 flex flex-col items-center justify-center cursor-pointer transition-colors text-slate-500 hover:text-emerald-700">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-1.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-hidden focus:border-emerald-500"
                    />
                    <button
                      type="button"
                    ...
                    <div className="flex gap-1">
                      {SAMPLE_IMAGE_PRESETS.map((preset, idx) => (
                        <button
                          ...
                          className="w-6 h-6 rounded-md overflow-hidden border border-slate-200 hover:ring-2 hover:ring-emerald-500"
                        >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-hidden focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 resize-none"
                  />
                </div>
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-sm rounded-xl transition-all shadow-md shadow-emerald-600/20 active:scale-98 disabled:opacity-50 flex items-center gap-2"
                  >
